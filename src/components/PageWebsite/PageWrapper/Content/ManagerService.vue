...
<script>
import AddModal from "../../../Layout/ModalService/AddService.vue"
import UpdateModal from "../../../Layout/ModalService/UpdateService.vue"
import DeleteModal from "../../../Layout/ModalService/DeleteService.vue"
...
export default {
    ...
    created() {
        this.columnDatas = this.$store.getters.columnDataService;
        this.datas = this.$store.getters.rowDataService;
    },
    ...
    methods: {
        Edit: function (e){
            ...
            this.$store.dispatch('getValueEditService', this.idedit)
                .then((data)=>{
