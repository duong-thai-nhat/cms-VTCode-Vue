...
<script>
import AddModal from "../../../Layout/ModalUser/ModalAdd.vue"
import UpdateModal from "../../../Layout/ModalUser/ModalUpdate.vue"
import DeleteModal from "../../../Layout/ModalUser/ModalDelete.vue"
...
export default {
    ...
    created() {
        this.columnDatas = this.$store.getters.columnDataUser;
        this.datas = this.$store.getters.rowDataUser;
    },
    ...
    methods: {
        Edit: function (e){
            ...
            this.$store.dispatch('getValueEditUser', this.idedit)
                .then((data)=>{
