...
<script>
import AddModal from "../../../Layout/ModalCustomer/AddCustomer.vue"
import UpdateModal from "../../../Layout/ModalCustomer/UpdateCustomer.vue"
import DeleteModal from "../../../Layout/ModalCustomer/DeleteCustomer.vue"
...
export default {
    ...
    created() {
        this.columnDatas = this.$store.getters.columnDataCustomer;
        this.datas = this.$store.getters.rowDataCustomer;
    },
    ...
    methods: {
        Edit: function (e){
            ...
            this.$store.dispatch('getValueEditCustomer', this.idedit)
                .then((data)=>{
